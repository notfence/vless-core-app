...
- `build/com.vlesscore.app_0.2.13-1_iphoneos-arm.deb`
...
```bash
# on build machine
scp build/com.vlesscore.app_0.2.13-1_iphoneos-arm.deb root@<iphone-ip>:/var/root/

# on iPhone
dpkg -i com.vlesscore.app_0.2.13-1_iphoneos-arm.deb
